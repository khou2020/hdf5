...
/* Get type */
H5_DLL herr_t   H5Rget_obj_type3(const href_t *ref_ptr, hid_t oapl_id, H5O_type_t *obj_type);

/* Get name */
H5_DLL ssize_t  H5Rget_file_name(const href_t *ref_ptr, char *name, size_t size);
H5_DLL ssize_t  H5Rget_obj_name(const href_t *ref_ptr, hid_t oapl_id, char *name, size_t size);
